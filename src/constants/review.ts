    ...
    topics: [
      {
        ...
        questions: [
          ...
          { question: 'Are unit tests follow the "given" "when" "then" / "arrange" "act" "assert" structure in their setup?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are unit tests specific and not asserting too many things in one test case?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are stubs used in a meaningful way to create isolated functionality and reduce dependencies?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are mocks used in a simple way to reduce dependencies and fake specific outcomes?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are mocks and test data (re)set before execution of each test?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are unit tests run in isolation using mocking, stubbing and direct calls where possible?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Is the HTML used to trigger functionality and assert the outcome of logical units?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Is defineExpose used to expose javascript only for testing purposes?', score: null, weight: 1, questionType: 'rating', comment: '' },
      ...
      },
      {
        ...
        questions: [
          ...
          { question: 'Are testcases formulated in a clear way to indicate expected behavior or outcome in specific scenarios?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are functional tests follow the "given" "when" "then" / "arrange" "act" "assert" structure in their setup?', score: null, weight: 1, questionType: 'rating', comment: '' },
      ...
      },
      {
        ...
        questions: [
          ...
          { question: 'Are the healthchecks triggered on the Test and Acceptance environment?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is performance testing triggered on the Test and Acceptance environment?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
        ],
      },
    ],
  },
  ...
  setup: {
    ...
    topics: [
      ...
      },
      {
        ...
        questions: [
          { question: 'Are protected files modified?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
        ],
      },
    ],
  },
  ...
  styling: {
    ...
    topics: [
      ...
      },
      {
        ...
        questions: [
          { question: 'Is Tailwind used with the "emc" prefix to apply styling?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Does the project deviate from the Emerald 2 Design System style guide?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Is styling applied using custom classes?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Is styling applied using tailwind and emerald parameters only?', score: null, weight: 1, questionType: 'rating', comment: '' },
          // { question: 'Is custom styling kept to a minimum?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Is inline styling avoided?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is any element positioning done using float and z-index?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Does the styling support different screen sizes?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are padding, margin and gap used correct ways to create spacing?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'iets met flex and col?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          // { question: 'Are the stylesheets logically located?', score: null, weight: 1, questionType: 'rating', comment: '' },
          // { question: 'Is the old emerald-global present?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          // { question: 'Is the old CSS-in-JS stack used?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
        ],
      },
    ],
  },
    ...
    topics: [
      {
        ...
        questions: [
          { question: 'Is text interpolation used correctly?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are attributes bound correctly with the v-bind shorthand (:) which is preferred over its longer version?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are boolean attributes bound correctly?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are objects of attributes bound correctly?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are JavaScript expressions inside of data bindings used correctly?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are functions called correctly?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Is v-html avoided?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is reactive state declared correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are methods declared correctly?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Is reactive() used correctly?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are computed properties used correctly?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are computed properties side-effect free?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are computed properties immutable?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is class binding used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is style binding avoided?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are the v-if, v-else-if, and v-else directives used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are the directives used in combination with the <template> tag to toggle more than one element?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is the v-show directive used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are v-if and v-for on the same element avoided?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is the v-cloak directive avoided?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is the v-for directive used correctly for an array?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is the v-for directive used correctly for an object?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is v-for used in combination with the <template> tag to render a block of multiple elements?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is the "key" attribute used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are events handled using the v-on shorthand (@) which is preferred over its longer version?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: "Are inline handlers' length and complexity acceptable?", score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are method handlers used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are original DOM events passed correctly to handlers?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are event modifiers used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are "key" modifiers used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are mouse button modifiers used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is v-model used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are modifiers used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are lifecycle hooks used correctly for the options API?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are lifecycle hooks used correctly for the Composition API?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is data retrieval done in the correct lifecycle hook?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is DOM manipulation done in the correct lifecycle hook?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is the amount of code in lifecycle hooks not excessive?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are watchers used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are deep watchers used cautiously?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are eager watchers used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is watchEffect() used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is callback flush timing used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are watchers stopped correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are refs used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are refs accessed correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are refs inside v-for used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are function refs used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are refs on components used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are composables used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: "Is the 'use' naming convention followed?", score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are input arguments handled correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are values returned correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are side effects handled correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are the usage restrictions kept in mind?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are composables correctly used for Code Organization?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are mixins avoided?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
        ],
      },
      {
        ...
        questions: [
          { question: 'Are components defined correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are components registered correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is the PascalCase name casing used?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are props defined correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is the camelCase name casing used for defining props?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are props used as kebab-case attributes?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is prop validation used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Do props have a type defined?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Do props have default value defined?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are events defined correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is the camelCase name casing used for defining events?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is the kebab-case name casing used for listening on events?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are events emitted correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is event listening correctly implemented?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are event arguments passed correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are events explicitly declared using the emits option?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is event validation used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are slots used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are named slots used correctly?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is the v-slot shorthand (#) used which is preferred over its longer version?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are there renderless components present?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
        ],
      },
      {
        title: 'Routing',
        ...
        questions: [
          { question: 'Are routes defined correctly?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are named routes used?(preferred way)', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is router-link or router.push used to navigate?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Is the namespacing of routes consistent?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Is there a fallback route in place?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is hashmode used?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is createWebHashHistory used?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are nested routes used correctly?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are navigation guards used correctly?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Is the meta field used correctly?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are the router files logically placed?', score: null, weight: 1, questionType: 'rating', comment: '' },
        ],
      },
    ],
  },
