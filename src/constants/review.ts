    ...
    topics: [
      {
        ...
        questions: [
          { question: 'Is ESlint enabled?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is the configuration in one file?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Does the configuration deviate?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are there any rules disabled in-line?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are there ESlint errors?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are there ESlint warnings?', score: null, weight: 1, questionType: 'rating', comment: '' },
        ],
      },
      {
        title: 'SonarQube',
        ...
        questions: [
          { question: 'Is SonarQube enabled?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Is the correct Quality gate enabled?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are there any Blocker issues?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are there any Critical issues?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are there any Major issues?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are there any Minor issues?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: "Are there any incorrectly marked 'false-positives' or 'wont-fix'?", score: null, weight: 1, questionType: 'trueFalse', comment: '' },
        ],
      },
      {
        title: 'HP Fortify',
        ...
        questions: [
          { question: 'Is HP Fortify enabled?', score: null, weight: 1, questionType: 'trueFalse', comment: '' },
          { question: 'Are there any Critical issues?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are there High any severity issues?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are there Medium any severity issues?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are there Low any severity issues?', score: null, weight: 1, questionType: 'rating', comment: '' },
        ],
      },
      {
        title: 'NexusIQ',
        ...
        questions: [
          ...
          { question: 'Are there Blocking (threat level >=8) violations?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are there Future Blocking (threat level 7) violations?', score: null, weight: 1, questionType: 'rating', comment: '' },
          { question: 'Are there other violations?', score: null, weight: 1, questionType: 'rating', comment: '' },
        ],
      },
    ],
  },
